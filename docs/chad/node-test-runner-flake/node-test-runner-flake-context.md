...
- Current atomic step: **[결정 대기] 지원 Node 범위** — `engines`를 `>=22`로 올릴 수 있는가?
...
- **node 18은 2025-04-30 EOL → 백포트 영구 불가.** node 20도 2026-04-30 EOL.
  현재 matrix `[18, 20]`은 **전부 지원 종료 런타임**이다.
