...
- [x] `npm run test` — 409 tests · 407 pass · 1 skipped · **1 fail(main 상속) — 그린 아님**
...
- [x] PR #39 생성 → **CI 그린** (run 32802290213, Node 18·20 pass). main 상속 실패는
      PR #40 머지분을 merge 커밋 `5bd7e54`로 반영해 해소. 머지 후 로컬 415 · 414 pass · 0 fail
