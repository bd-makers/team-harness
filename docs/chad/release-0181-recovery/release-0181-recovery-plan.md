...
## 단계
- [x] 원인 재현 — `npm run test`에서 `what-changes-latest-version.test.mjs` ENOENT 확인
- [x] 계약 확인 — 테스트가 요구하는 3가지(제목 버전 / 요약 `<dt>버전</dt>` / 스냅샷 완전 일치)
- [x] `docs/what-changes-0.18.1.html` 작성 (0.18.0·0.16.1 스냅샷 구조·톤 준수, 자립형 정적 HTML)
